...
WebSocketを使用したリアルタイム通信により、2〜6人が同時にプレイできるカードゲームWebアプリケーション。
...
3. **通常 or バースト**:
   - **通常**: もう1枚引くか、ターン終了するかを選択できる（横取り解決後も同様）
   - **バースト**: 場に4枚以上ある状態で、引いたカードの数字が場の既存カードと一致した場合 → 場のカードをすべて失う（得点化不可）、強制ターン終了
